                        ...
                        <tbody>
                            <?php $__currentLoopData = $business; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="<?php echo e($val->admin_enable == 'off' ? 'row-disabled' : ''); ?>" >
                                    ...
                                    <td class="">
                                        <a class=""
                                            href="<?php echo e(route('bussiness.get_card', $val->slug)); ?>"><b><?php echo e(ucFirst($val->title)); ?></b></a>
                                    </td>
                                    <td><span
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Ubrand\resources\views/business/index.blade.php ENDPATH**/ ?>