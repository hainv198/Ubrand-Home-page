    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-sm-12 d-flex align-items-center">
                <img src="<?php echo e(asset('landing/assets/img/homepage/image_contact.png')); ?>" alt="hero" class=" img-fluid">
            </div>
            <div class="col-lg-6 col-sm-12" >
                <div class="form-contact-homepage">
                    <div class="blog-heading">
                        <h3>
                            <?php echo e(__('Liên hệ với')); ?> <span style="color: #2F38FF; font-weight: bold"><?php echo e(__('đội ngũ nhân viên')); ?></span> <?php echo e(__('bán hàng của chúng tôi')); ?>
...
<?php /**PATH C:\Ubrand\resources\views/layouts/homepage/components/home/contact.blade.php ENDPATH**/ ?>